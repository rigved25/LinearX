...
struct BLParams {
  ...
  const static int ninio37 = 50;
  const static int TerminalAU37 = 56;

  inline const static int hairpin37[31] = {
      POS_INF, POS_INF, POS_INF, 364, 282, 297, 287, 259, 259, 272, 283,
  ...
  inline const static int dangle5_37[8][5] = {
      /*   @     A     C     G     U   */
      {0, 0, 0, 0, 0},     /* no pair */
      {POS_INF, -8, 0, 0, 0},  /* CG  (stacks on C) */
      {POS_INF, -10, 0, 0, 0}, /* GC  (stacks on G) */
      {POS_INF, 0, 0, 0, 0},   /* GU */
      {POS_INF, 0, 0, 0, 0},   /* UG */
      {POS_INF, -10, 0, 0, 0}, /* AU */
      {POS_INF, -3, 0, 0, 0},  /* UA */
  ...
  inline const static int dangle3_37[8][5] = {
      /*   @     A     C     G     U   */
      {0, 0, 0, 0, 0},          /* no pair */
      {POS_INF, -10, -9, -51, -14}, /* CG  (stacks on G) */
      {POS_INF, -41, 0, -46, -35},  /* GC */
      {POS_INF, -10, 0, -50, -2},   /* GU */
      {POS_INF, -10, -40, -60, 0},  /* UG */
      {POS_INF, -10, -13, -25, -7}, /* AU */
      {POS_INF, -10, -30, -44, -7}, /* UA */
      {0, 0, 0, 0, 0}           /*  @ */
  };

  inline const static int stack37[8][8] =
      /* NN   CG   GC   GU   UG   AU   UA   NN*/
      {{0, 0, 0, 0, 0, 0, 0, 0},
       {0, -133, -207, -146, -37, -139, -132, 0},
       {0, -207, -205, -150, -91, -129, -123, 0},
       {0, -146, -150, -22, -67, -81, -58, 0},
       {0, -37, -91, -67, -38, -14, -2, 0},
       {0, -139, -129, -81, -14, -84, -69, 0},
       {0, -132, -123, -58, -2, -69, -68, 0},
       {0, 0, 0, 0, 0, 0, 0, 0}};

  inline const static int bulge37[31] = {POS_INF, 281, 157, 201, 288, 298, 272, 288,
                                         303, 315, 327, 337, 346, 355, 363, 370,
                                         377, 384, 390, 396, 401, 407, 412, 416,
                                         421, 425, 430, 434, 438, 442, 445};

  inline const static int internal_loop37[31] = {
      POS_INF, POS_INF, POS_INF, POS_INF, 83,  118, 90,  106, 121, 133, 145,
