...
CONFIGS = {
    'noflag':   {'path': '/nfs/hpc/share/naukarkr/LiangHuang/LTF2/LinearX/tests/linearturbofold/outputbasic_noflag',   'label': 'noflag',                  'color': 'blue',   'linestyle': '--', 'marker': 'o'},
    'res':      {'path': '/nfs/hpc/share/naukarkr/LiangHuang/LTF2/LinearX/tests/linearturbofold/outputbasic_res',       'label': 'posterior pruning',       'color': 'red',    'linestyle': ':',  'marker': '^'},
    'lazy':     {'path': '/nfs/hpc/share/naukarkr/LiangHuang/LTF2/LinearX/tests/linearturbofold/outputbasic_lazy',      'label': 'lazy',                     'color': 'purple', 'linestyle': '-',  'marker': 'd'},
    'lazy_res': {'path': '/nfs/hpc/share/naukarkr/LiangHuang/LTF2/LinearX/tests/linearturbofold/outputbasic_lazy_res',  'label': 'lazy + posterior pruning', 'color': 'orange', 'linestyle': '-',  'marker': 'x'},
}
