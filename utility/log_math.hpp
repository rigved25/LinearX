    ...
    if (x < double (3.3792499610)) {
        ...
        if (x < double (2.4912588184))
            return ((double (-0.0128909247) * x + double (0.1301028251)) * x + double (0.5150398748)) * x +
                   double (0.6795585882);
        return ((double (-0.0072142647) * x + double (0.0877540853)) * x + double (0.6208708362)) * x + double (0.5909675829);
    }
    if (x < double (5.7890710412)) {
        if (x < double (4.4261691294))
            return ((double (-0.0031455354) * x + double (0.0467229449)) * x + double (0.7592532310)) * x +
                   double (0.4348794399);
        return ((double (-0.0010110698) * x + double (0.0185943421)) * x + double (0.8831730747)) * x + double (0.2523695427);
    }
    if (x < double (7.8162726752))
        return ((double (-0.0001962780) * x + double (0.0046084408)) * x + double (0.9634431978)) * x + double (0.0983148903);
    ...
    if (x < double (-2.4915033807)) {
        ...
        if (x < double (-3.8396630909))
            return ((double (0.0013889414) * x + double (0.0244676474)) * x + double (0.1471290604)) * x +
                   double (0.3042757740);
        return ((double (0.0072335607) * x + double (0.0906002677)) * x + double (0.3983111356)) * x + double (0.6245959221);
    }
    if (x < double (-0.6725053211)) {
        if (x < double (-1.4805375919))
            return ((double (0.0232410351) * x + double (0.2085645908)) * x + double (0.6906367911)) * x +
                   double (0.8682322329);
        return ((double (0.0573782771) * x + double (0.3580258429)) * x + double (0.9121133217)) * x + double (0.9793091728);
    }
    if (x < double (0))
        return ((double (0.1199175927) * x + double (0.4815668234)) * x + double (0.9975991939)) * x + double (0.9999505077);
